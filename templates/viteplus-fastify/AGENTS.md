...
- Use the shared starter recipes for copyable Fastify API and page examples: https://github.com/brandonxiang/viteplus-collections/blob/main/docs/recipes.md
